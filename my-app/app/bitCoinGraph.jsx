...
import { Slider, SliderTrack, SliderFilledTrack, SliderThumb, Button, HStack, VStack, Text, Card, CardBody } from '@chakra-ui/react';
      ...
      <CardBody>
        <HStack align="start">
          ...
          <VStack align="start" spacing={4}>
            <Text fontSize="m" fontWeight="bold">INSIGHTS</Text>
            <TrendEmojis data={data} />
          </VStack>
        </HStack>
        <div className="controls w-full mt-5">
          <VStack spacing={4} align="stretch" width="full">
            <Text fontSize="m" fontWeight="bold">CONFIGURATIONS</Text>
